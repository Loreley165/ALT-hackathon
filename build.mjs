...
for (const file of ['alt-logo.svg','index.html','styles.css','app.js','result-ui.js','result-ui.css','alt-brand-reference.png','alt-passport-reference.png']) await copyFile(file, `dist/${file}`);
